...
import frc.robot.WPI.SwerveModule;
...
*/
    private double heightMeters = MkUtil.inchesToMeters(Constants.heightInch / 2);
    private double widthMeters = MkUtil.inchesToMeters(Constants.widthInch / 2);
